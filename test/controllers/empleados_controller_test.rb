...
class EmpleadosControllerTest < ActionController::TestCase
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post :create, empleado: { anio_de_contratacion: @empleado.anio_de_contratacion, nombre: @empleado.nombre }
    end
  ...
  test "should update empleado" do
    patch :update, id: @empleado, empleado: { anio_de_contratacion: @empleado.anio_de_contratacion, nombre: @empleado.nombre }
    assert_redirected_to empleado_path(assigns(:empleado))
  end
